...
foreach(CHUNKTYPE IN ITEMS ${CHUNKTYPES})
    string(REGEX REPLACE "^([^ ]+) '([A-z ]+)'.*" "#define kcctg\\1 '\\2'" CHUNKTYPE_STR "${CHUNKTYPE}")
    file(APPEND "${OUTPUT_FILE}" "${CHUNKTYPE_STR}\n")
    string(REGEX REPLACE "^([^ ]+) '([A-z ])([A-z ])([A-z ])([A-z ])'.*" "#define kctg\\1 KLCONST4('\\2', '\\3', '\\4', '\\5')" CHUNKTYPE_STR "${CHUNKTYPE}")
    file(APPEND "${OUTPUT_FILE}" "${CHUNKTYPE_STR}\n")
endforeach()
